...
scena
  ...
  .addText(messaggio, " I can't see anything around me...", {
    mustPress: true,
    clearText: true,
  })
  ...
  .wait(2000)
  .clearText(messaggio)
  .addText(messaggio, "Well, that's quite a mess.", {
    mustPress: true,
    clearText: true,
  })
  .wait(1400)
  ...
  .addText(messaggio, "Maybe you can help me.", {
    mustPress: true,
    clearText: true,
  })
  ...
  .addText(messaggio, " I suppose.", { mustPress: true, clearText: true })
  .wait(1500)
  .addText(messaggio, "Anyway, back to work.", {
    mustPress: true,
    clearText: true,
  })
  .addText(
  ...
  .addText(messaggio, "that didn't worked as I expected.", {
    mustPress: true,
    clearText: true,
  })
  .addText(
